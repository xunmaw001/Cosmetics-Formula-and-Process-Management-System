                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="kzpname" name="kzpname" class="form-control"
                                                   v-model="ruleForm.kzpname" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="pinpaiValue" name="pinpaiValue" class="form-control"
                                               v-model="ruleForm.pinpaiValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="huazhuangpinId" name="huazhuangpinId" v-model="ruleForm.huazhuangpinId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="maxexpense" name="maxexpense" class="form-control"
                                               v-model="ruleForm.maxexpense" readonly>
                                    </div>
