                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                化妆品名称
                                                <input type="text" id="kzpnameSearch"  style="width: 120px;" class="form-control form-control-sm"
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        //总价
        var maxexpenseCell = document.createElement('td');
        maxexpenseCell.innerHTML = item.maxexpense;
        row.appendChild(maxexpenseCell);
