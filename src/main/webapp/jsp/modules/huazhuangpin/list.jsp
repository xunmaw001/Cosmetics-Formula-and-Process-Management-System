                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            化妆品名称
                                            <input type="text" id="kzpnameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="化妆品名称" aria-controls="tableId">
                                        </label>
                                 
                                            <label>
                                                品牌
                                                <select name="pinpaiTypesSelectSearch" style="width: 100px;" id="pinpaiTypesSelectSearch" class="form-control form-control-sm"
                                ...
                                <button onclick="purchase()" type="button" class="btn btn-success 购买">购买</button>
                            </div>
...
<script>
    ...
    <!-- 本表的查询条件 -->
        ...
        //化妆品名称
        var kzpnameSearchInput = $('#kzpnameSearch');
        if( kzpnameSearchInput != null){
            if (kzpnameSearchInput.val() != null && kzpnameSearchInput.val() != '') {
                searchForm.kzpname = $('#kzpnameSearch').val();
            }
        }
     
            //品牌
        var pinpaiTypesSelectSearchInput = document.getElementById("pinpaiTypesSelectSearch");
        if(pinpaiTypesSelectSearchInput != null){
            var pinpaiTypesIndex = pinpaiTypesSelectSearchInput.selectedIndex;
            if( pinpaiTypesIndex  != 0){
                searchForm.pinpaiTypes= document.getElementById("pinpaiTypesSelectSearch").options[pinpaiTypesIndex].value;
            }
        }
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("huazhuangpin/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addhuazhuangpin", "addhuazhuangpin");
        window.location.href = "add-or-update.jsp"
    }
